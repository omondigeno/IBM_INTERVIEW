...
//            }
        ...
        {
            eColumnChartLabel = [[EColumnChartLabel alloc] initWithFrame:CGRectMake((widthOfTheColumnShouldBe * 0.5 + (i * widthOfTheColumnShouldBe * 1.5))-82, self.frame.size.height+45, widthOfTheColumnShouldBe+100, 15)];
            [eColumnChartLabel setTextAlignment:NSTextAlignmentRight];
